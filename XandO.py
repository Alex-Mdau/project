...
storage.title("X and O")


tk.Label(storage, text="X and O", font=('poppins', 25)).pack()
status_label = tk.Label(storage, text="X's turn", font=('poppins', 15), bg='grey', fg='snow')
status_label.pack(fill=tk.X)
#prompts users to play again
def playAgain():
    global currentChar
    currentChar = 'X'
...
playAgain = tk.Button(storage, text='Play again', font=('poppins', 15), fg='red', command=playAgain)
#main game code
currentChar = "X"
